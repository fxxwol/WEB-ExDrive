namespace exdrive_web.Models
{
    public class ExFunctions
    {
        ...
        public static readonly string sqlConnectionString = "Server=tcp:exdrive.database.windows.net,1433;Initial Catalog=Exdrive;Persist Security Info=False;User ID=fxxwol;Password=AbCD.123;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;";
